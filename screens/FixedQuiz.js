...
const FixedQuiz = ({route, navigation}) => {
    ...
    const RankUser = (name, score, value) => {
        ...
        // api.post('/postRank', {name, score, value}).then(function(response) {
            ...
            <View>
                {
                    allQuestions[currentQuestionIndex]?.options.map(option => (
                        ...
                        >
                            <Text style={{fontSize: 12, color: COLORS.white}}>{option}</Text>

                            {/* Show Check Or Cross Icon based on correct answer*/}
                            {
                                option==correctOption ? (
                                    <View style={{
                                        width: 30, maxHeight: 50, borderRadius: 30/2,
